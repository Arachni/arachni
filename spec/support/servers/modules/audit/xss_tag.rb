...
get "/link/no" do
    ...
    "<a href='/' class=#{params['input']}>Vuln</a>"
end
...
get "/cookie/no" do
    ...
    "<a href='/' class=#{cookies['cookie']}>Vuln</a>"
end
...
get "/cookie/single" do
    ...
    "<a href='/' class='#{cookies['cookie1']}'>Vuln</a>"
end
...
get "/cookie/double" do
    ...
    "<a href='/' class=\"#{cookies['cookie2']}\">Vuln</a>"
end
...
get "/header/no" do
    ...
    "<a href='/' class=#{env['HTTP_USER_AGENT']}>Vuln</a>"
end
