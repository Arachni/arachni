    ...
    context 'when operating in simple mode' do
        ...
        describe :status do
            before( :all ) do
                ...
                @inst.opts.url = server_url_for( :framework ) + '/crawl'
            ...
            context 'during audit' do
                it 'should return "audit"' do
                    ...
                    inst = @get_instance.call
                    inst.opts.url = server_url_for( :framework )
        ...
        describe :restrict_to_elements! do
            it 'should restrict the audit to the provided element signatures' do
                ...
                inst.opts.url = server_url_for( :framework ) + '/restrict_to_elements'
