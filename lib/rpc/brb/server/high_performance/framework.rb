...
require Options.instance.dir['lib'] + 'rpc/brb/server/framework'
require Options.instance.dir['lib'] + 'rpc/brb/server/module/manager'
require Options.instance.dir['lib'] + 'rpc/brb/server/plugin/manager'
...
class Framework
    ...
    def initialize( opts )
        ...
        @framework = Arachni::RPC::BrB::Server::Framework.new( opts )
    ...
    #
    # @see Arachni::RPC::BrB::Server::Framework#abort!
    #
    def abort!
        @job.kill
        return true
    ...
    #
    # @see Arachni::RPC::BrB::Server::Framework#busy?
    #
    def busy?
        return false if !@job
        return @job.alive?
    ...
    #
    # @see Arachni::RPC::BrB::Server::Framework#debug?
    #
    def debug?
        @@debug
    end
    ...
    #
    # @see Arachni::RPC::BrB::Server::Framework#verbose?
    #
    def verbose?
        @@verbose
    end
    ...
    #
    # @see Arachni::RPC::BrB::Server::Framework#lsplug
    #
    def lsplug
    ...
    #
    # @see Arachni::RPC::BrB::Server::Framework#lsmod
    #
    def lsmod
        @framework.lsmod
    end
    ...
    #
    # @see Arachni::RPC::BrB::Server::Framework#pause!
    #
    def pause!
        @framework.pause!
    ...
    #
    # @see Arachni::RPC::BrB::Server::Framework#resume!
    #
    def resume!
        @framework.resume!
    ...
    def progress_data
        ...
        begin
            ...
            if @framework.opts.datastore[:dispatcher_url]
                ...
                data['instances'][self_url]['url'] = self_url.to_s
    ...
    def connect_to_instance( instance )
        ...
        return Arachni::RPC::BrB::Client::Instance.new( @opts, instance['url'], @tokens[instance['url']] )
    end
    ...
    def connect_to_dispatcher( url )
        Arachni::RPC::BrB::Client::Dispatcher.new( @opts, url )
    end
