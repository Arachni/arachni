...
//                trace_data.error = error;
    ...
    add_trace_to_prototypes: function () {
        ...
        _token.add_trace_to_namespace( Text.prototype );

        _token.add_trace_to_namespace( Document.prototype );
        _token.add_trace_to_namespace( HTMLDocument.prototype );

        _token.add_trace_to_namespace( Node.prototype );
        _token.add_trace_to_namespace( Element.prototype );
        _token.add_trace_to_namespace( HTMLElement.prototype );
