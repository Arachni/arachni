...
//                    debug( element.injector().get( '$http' )( {method: 'GET', url: '/'}));
//                    debug( window.$HttpProvider );
//                    debug( 1 );
//                });
//            }
        ]
            ...
            switch( toString ) {
                ...
                case '[object Event]':
                    ...
                    for( var prop in arguments[i] ) {
                        if( elements.indexOf( prop ) != -1 && arguments[i][prop] ) {
                            if( arguments[i][prop].innerHTML ) {
                                arg[prop] = arguments[i][prop].innerHTML;
                            } else if( arguments[i][prop].documentElement ) {
                                arg[prop] = arguments[i][prop].documentElement.outerHTML;
                            } else {
                                arg[prop] = arguments[i][prop].toString();
                            }
                        } else {
                            arg[prop] = arguments[i][prop];
                        }
                    }
