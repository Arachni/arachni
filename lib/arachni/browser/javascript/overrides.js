...
//                    }
    ...
    update_tracers: function () {
        ...
        if( window.jQuery ) {
            _token.add_trace_to_function( jQuery.fn, 'html', 'jQuery' );
            _token.add_trace_to_function( jQuery.fn, 'text', 'jQuery' );
            _token.add_trace_to_function( jQuery.fn, 'append', 'jQuery' );
            _token.add_trace_to_function( jQuery.fn, 'prepend', 'jQuery' );
            _token.add_trace_to_function( jQuery.fn, 'before', 'jQuery' );
            _token.add_trace_to_function( jQuery.fn, 'prop', 'jQuery' );
            _token.add_trace_to_function( jQuery.fn, 'replaceWith', 'jQuery' );
            _token.add_trace_to_function( jQuery.fn, 'val', 'jQuery' );
        }

        if( window.angular ) {
            // JQLite is private so we've got to be creative to get the prototype.
            var JQLitePrototype = Object.getPrototypeOf( angular.element( document ) );

            _token.add_trace_to_function( JQLitePrototype, 'html', 'angular.element' );
            _token.add_trace_to_function( JQLitePrototype, 'text', 'angular.element'  );
            _token.add_trace_to_function( JQLitePrototype, 'append', 'angular.element'  );
            _token.add_trace_to_function( JQLitePrototype, 'prepend', 'angular.element'  );
            _token.add_trace_to_function( JQLitePrototype, 'prop', 'angular.element'  );
            _token.add_trace_to_function( JQLitePrototype, 'replaceWith', 'angular.element'  );
            _token.add_trace_to_function( JQLitePrototype, 'val', 'angular.element'  );
        }
    },
